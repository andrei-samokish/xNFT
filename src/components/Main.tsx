	...
	return (
		<div className="flex flex-row w-full my-16 flex-wrap gap-12 justify-between max-[1235px]:justify-center">
			<div className="flex flex-col gap-5 flex-grow max-[1235px]:items-center">
				<p className="text-white font-bold text-lg">Powered by Polygon zkEVM Testnet</p>
				...
				<p className="text-white font-bold text-lg">Mint conditions: 1000 APE on Goerli network</p>
			</div>
			<div className="rounded-xl flex flex-col w-[402px] max-[1235px]:justify-center">
				<Slider {...settings}>
					<div className="bg-secondary h-[254px] w-[402px] text-center p-[100px] rounded-xl text-6xl font-bold text-primary">
						1
					</div>
					<div className="bg-secondary h-[254px] w-[402px] text-center p-[100px]  rounded-xl text-6xl font-bold text-primary">
						2
